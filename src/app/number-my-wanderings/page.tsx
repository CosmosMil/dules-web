...
const NMW = () => {
  ...
  return (
    <main className='mt-5'>
      <h1 className='p-6 text-xl md:text-2xl xl:text-3xl text-center text-purple-600 italic font-bold'>NUMBER MY WANDERINGS</h1>
      ...
      <div className='flex flex-col p-3'>
        ...
        <div className='flex flex-col text-center mt-5'>
          ...
          <p className='text-sm md:text-base xl:text-xl font-bold'>Selin Kavak | Johannes Völkel | Florian Denk | Vera Maria Kremers | Jelena Bosanac | Yazan Melhem | Omar Crow | Cem Sultan Ungan
