      ...
      <div className='flex justify-center w-screen'>
        <section className='grid grid-flow-row xl:grid-flow-col'>
          ...
          <div className='p-8 mr-8 text-justify lg:text-lg'>
            <div> Dušan Solomun is a Berlin-based director, cinematographer and photographer. He graduated from FH Dortmund with a major in film and television camera and documentary filmmaking. During his studies at the FH Dortmund, Solomun spent a year at the Bezalel Arts Academy in Jerusalem. There, he produced his debut full length documentary <Link className='text-purple-600' href='/lod-on-the-map'>LOD ON THE MAP!</Link> about two musicians from a small town in the heart of Israel, dreaming of a career. The film premiered at the Israel Film Festival Berlin in 2012.</div>
